...
/*   Updated: 2024/08/28 17:57:10 by ajehle           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed& Fixed::ft_min(Fixed& a, Fixed& b)
{
	if(a < b)
		return(a);
	else
...
Fixed& Fixed::ft_max(Fixed& a, Fixed& b)
{
	if(a > b)
		return(a);
	else
...
const Fixed& Fixed::ft_min(const Fixed& a,const  Fixed& b)
{
	if(a < b)
		return(a);
	else
...
const Fixed& Fixed::ft_max(const Fixed& a,const  Fixed& b)
{
	if(a > b)
		return(a);
	else
