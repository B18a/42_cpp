...
/*   Updated: 2024/08/28 17:47:56 by ajehle           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Fixed
{
  public:
	...
	static Fixed& ft_min(Fixed& a, Fixed& b);
	static Fixed& ft_max(Fixed& a, Fixed& b);
	static const Fixed& ft_min(const Fixed& a,const Fixed& b);
	static const Fixed& ft_max(const Fixed& a,const Fixed& b);
